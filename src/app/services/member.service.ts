...
export class MemberService {
  ...
  getMemberById(memberId: number): Observable<Member[]> {
    return this.httpClient.get<Member[]>( AUTH_API + '/api/projects/members/' + memberId);
  }

  getAllMembersByProject(memberId: number): Observable<Member[]> {
    return this.httpClient.get<Member[]>( AUTH_API + '/api/projects/members/projects/' + memberId);
  }

  createMember(member: Member): Observable<any> {
    return this.httpClient.post(AUTH_API + '/api/projects/members/' , member);
  }

  updateMember(memberId: number,member:Member): Observable<any> {
    return this.httpClient.put(AUTH_API + '/api/projects/members/' + memberId, member);
  }
